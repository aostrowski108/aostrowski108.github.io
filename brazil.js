    ...
    return fetch("results.csv")
        ...
        .then(csvText => {
            ...
            data.forEach(d => {
                ...
                if (winner in winsByCountry && year <= 1999) {
...
function renderChart(data) {
    ...
    const annotations = [
        {
            note: {
                label: "Brazil finally took over the International English Giants after 126 years", // The text for the annotation
                // title: "England beat Scotland to win the first international game!", // The title for the annotation
            },
            x: width - margin.right, // Place the annotation on the right side
